...
import { createInventoryBackground, createInventoryItemsTexture, modifyInventoryTexture } from "../helper/invMenu.js";
...
async function not_init() {
    ...
    console.log(swordGame.test_level); 
    console.log(swordGame.test_level.grid[8][4]); 

    
    swordGame.renderer.gameLevel = testLevel;
    console.log(swordGame.renderer.gameLevel)
    ...
    // console.log(testLevel.mapLayers[0].texture.mapFloor.canvas)
